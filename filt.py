...
passed_filename, failed_filename = check_output_base_name(args.output_base_name)
...
'''
def create_failed_file(args_keep_filtered):
    if args_keep_filtered:
        _, failed_filename = check_output_base_name(args.output_base_name)
...
if file with this name exits contents of the file are deleted
'''
def create_passed_file():
    with open(passed_filename, "w") as file_passed:
        pass
    return file_passed

create_failed_file(args.keep_filtered)
create_passed_file()
